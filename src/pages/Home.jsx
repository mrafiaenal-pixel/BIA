      ...
      <header className="pt-48 pb-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center gap-4">
            <button className="bg-stone-800 text-white px-8 py-3 rounded-xl hover:bg-stone-900 transition active:scale-95">
              Mulai Laporan
            </button>
            <button
              onClick={() => setCount(count + 1)}
              className="border border-stone-300 px-8 py-3 rounded-xl hover:bg-stone-100 transition active:scale-95"
            >
              Klik Dihitung: {count}
            </button>
          </div>
